<template>
    <table class="text-sm w-full mt-5 mb-4">
        ...
        <tbody>
            <tr v-on:click="updateRole(role)" v-for="(role, i) in dataForm.data" :key="i" class="border-gray-600 hover:bg-gray-100">
...
export default {
    ...
    beforeMount() {
        this.header.title = 'User Roles';
        this.header.path = 'User Management > User Role';
    },
    methods: {
        addRole(){
            this.id = null;
            ...
            this.dataForm.title = "Add User Role"
        ...
        updateRole(role)
        {
            if(role.id == 1)
            {
                ...
                this.systemAlert.message = 'You cannot edit Administrator role';
            }
            else
            {
                this.id = role.id;
                ...
                this.dataForm.title = "Update User Role"
                this.dataForm.show = true;
